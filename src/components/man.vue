...
import { Indicator } from 'mint-ui';
	export default{
		...
		mounted(){
			...
			axios.get("/appapi/silo/eventForH5?categoryId=men&pageIndex=1&timestamp=1541033102217&summary=beb1403fde8e48ea3da281e84a4f3ae9&platform_code=H5").then(res=>{
