...
import { Indicator } from 'mint-ui';
	export default{
		...
		mounted(){
			...
			axios.get("/appapi/silo/eventForH5?categoryId=crossborder&pageIndex=1&timestamp=1541031310503&summary=6c4d0017a91fb0831307e6ac4355e525&platform_code=H5").then(res=>{
