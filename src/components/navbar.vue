	...
	<div class="navbar" v-if="$store.state.isCreate">
		...
		<nav>
			<ul>				
				...
				<router-link tag="li" to="/cosmetics" activeClass="kerwinactive"><span>美妆</span></router-link>
				<router-link tag="li" to="/lifestyle" activeClass="kerwinactive"><span>家居</span></router-link>
				<router-link tag="li" to="/kids" activeClass="kerwinactive"><span>婴童</span></router-link>	
			</ul>
		</nav>
	</div>
</template>
