...
import { Indicator } from 'mint-ui';
	export default{
		...
		mounted(){
			...
			axios.get("/appapi/silo/eventForH5?categoryId=cosmetics&pageIndex=1&timestamp=1541032948896&summary=db4bbd477ab83ec79ce64e2e61045d77&platform_code=H5").then(res=>{
