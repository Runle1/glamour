...
import { Indicator } from 'mint-ui';
    export default{
        ...
        mounted(){
            ...
            axios.get("/appapi/silo/eventForH5?categoryId=kids&pageIndex=1&timestamp=1541032207435&summary=080cc9b366382400ff8bc515c818e550&platform_code=H5").then(res=>{
