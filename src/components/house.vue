...
import { Indicator } from 'mint-ui';
	export default{
		...
		mounted(){
			...
			axios.get("/appapi/silo/eventForH5?categoryId=lifestyle&pageIndex=1&timestamp=1541032823156&summary=d7746018ef6cde39a1b0e3a88907406c&platform_code=H5").then(res=>{
